            ...
            {bookmarkedRecipes.map((recipe) => (
              ...
              >
                <img
                  ...
                  alt={recipe.title}
                  className="w-20 h-16 object-cover rounded-3xl"
                />
                <p className="text-white font-normal flex-1 text-xs">
                  {recipe.title}
                </p>
                <button
                  className="btn btn-xs mr-8 bg-[#555555] hover:bg-[#27272A] text-white border-none"
