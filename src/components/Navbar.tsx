...
export const Navbar: React.FC<NavbarProps> = ({ onToggleDrawer, bookmarkCount }) => {
                    ...
                    <div className='indicator'>
                        <div className="flex justify-end pr-4 relative">
                            <button onClick={onToggleDrawer}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22" fill="#3F3F46" className="w-6 h-6">
